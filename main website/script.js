...
document.addEventListener('DOMContentLoaded', () => {
    ...
    navLinks.forEach(link => {
        link.addEventListener('mousemove', (e) => {
            ...
            link.style.transform = `perspective(1000px) rotateX(${rotateX}deg) rotateY(${rotateY}deg) translateZ(20px)`;
        });
    ...
    const navButtons = document.querySelectorAll('.nav-buttons .btn-ghost');
    ...
    function highlightNavigation() {
        ...
        sections.forEach(section => {
            ...
            if (scrollY > sectionTop && scrollY <= sectionTop + sectionHeight) {
                document.querySelector(`.nav-buttons .btn-ghost[data-section="${sectionId}"]`)
